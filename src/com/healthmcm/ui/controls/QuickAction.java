package com.healthmcm.ui.controls;
...
public class QuickAction extends PopUpWindow {
	...
	public QuickAction(Context context) {
		...
		//setRootViewId(R.layout.layout_quick_action);
		mRootView	= (View) inflater.inflate(R.layout.layout_quick_action, null);
	...
	public void addActionItem(ActionItem action) {
		...
		View container	= (View) inflater.inflate(R.layout.layout_quick_action_item, null);
